...
export class PmUiCurtainTabComponent {
...
@Component({
  ...
  templateUrl: './pm-ui-curtains.component.html',
  styleUrls: ['./pm-ui-curtains.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class PmUiCurtainsComponent implements AfterViewInit {
  @Input() color1 = 'maroon';
  @Input() color2 = 'red';
  ...
  @ContentChildren(PmUiCurtainTabComponent, { descendants: true })
  tabs: QueryList<PmUiCurtainTabComponent>;
